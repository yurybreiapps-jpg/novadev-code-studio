...
s_what = section("what", '''        <h2 class="display">What it does</h2>
        ...
        <div class="card">
          ...
          <div class="shot-pair">
            <figure>
              <img src="../assets/apps/ai-images/upscale-before.webp" alt="A detail of embroidered kimono fabric from the original image, the gold thread soft and the pattern edges indistinct" width="760" height="760" loading="lazy">
              <figcaption><strong>Before</strong> &middot; A detail from the 1,536-pixel original, brought to this size by plain enlargement.</figcaption>
            </figure>
            <figure>
              <img src="../assets/apps/ai-images/upscale-after.webp" alt="The same detail from the enhanced 4,096-pixel version, with individual gold threads and pattern edges clearly defined" width="760" height="760" loading="lazy">
              <figcaption><strong>After</strong> &middot; The same detail from the app's 4,096-pixel result. Thread, folds and pattern edges rebuilt.</figcaption>
            </figure>
          </div>
          <div class="shot-pair">
            <figure>
